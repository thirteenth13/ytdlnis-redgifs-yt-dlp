...
# Retry a direct TikTok webpage HTTP 403 once. Keep this deliberately small to
# avoid making profile downloads more likely to hit TikTok 429 rate limits.
...
if 'TikTok returned HTTP 403; retrying webpage once' not in text:
...
print(f'Patched {path}: conservative TikTok app/API + webpage 403 retries enabled')
